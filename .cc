...
# CONFIG_TARGET_sunxi_cortexa53_DEVICE_xunlong_orangepi-one-plus is not set
...
# Image Options
#
CONFIG_SUNXI_SD_BOOT_PARTSIZE=30
...
# Boot Loaders
#
CONFIG_PACKAGE_arm-trusted-firmware-sunxi-a64=y
# CONFIG_PACKAGE_arm-trusted-firmware-sunxi-h6 is not set
...
# CONFIG_PACKAGE_luci-app-ssr-plus_INCLUDE_Shadowsocks_Server is not set
